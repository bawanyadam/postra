...
<pre class="bg-light p-2 border rounded embed-snippet"><code>&lt;form action=&quot;<?= htmlspecialchars($_ENV['APP_URL'] ?? 'http://localhost:8000') ?>/form/<?= htmlspecialchars($form['public_id']) ?>&quot; method=&quot;POST&quot;&gt;
  &lt;!-- Honeypot: keep empty --&gt;
